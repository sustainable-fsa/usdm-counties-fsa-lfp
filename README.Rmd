...
The county data used in this repository were acquired via FOIA request **2025-FSA-08431-F** by R. Kyle Bocinsky (Montana Climate Office) and fulfilled on September 8, 2025. The FOIA response, including the original Esri file geodatabase, is archived at [`https://sustainable-fsa.github.io/fsa-lfp-counties`](https://sustainable-fsa.github.io/fsa-lfp-counties).
...
- **FSA LFP County Boundaries**: Acquired via FOIA request [**2025-FSA-08431-F**](ttps://sustainable-fsa.github.io/fsa-lfp-counties).
...
> US Drought Monitor authors and R. Kyle Bocinsky YYYY. *US Drought Monitor Weekly Maps Aggregated to FSA LFP County Boundaries*. Data processed, curated, and archived by R. Kyle Bocinsky, Montana Climate Office. Accessed via GitHub archive, YYYY-MM-DD. https://sustainable-fsa.github.io/usdm-counties-fsa-lfp/
